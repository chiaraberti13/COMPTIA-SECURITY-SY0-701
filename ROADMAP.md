...
- [ ] **P0 — Consolidare la struttura esistente** invece di riorganizzarla da zero. Struttura di riferimento (in grassetto le aggiunte):
  ...
  ├── hooks/                     # stato delle sezioni (useAiChat, useQuizSession, useRemediation, useStudySession dal 2026-09-26)
...
| Manutenzione | Righe di `src/App.tsx` | ~2.210 (2026-09-26, erano ~2.810 dopo le ultime funzioni; ~2.550 all'audit iniziale) | < 500 |
