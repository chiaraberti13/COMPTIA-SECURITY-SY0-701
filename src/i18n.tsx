...
const it = {
  ...
  "tab.studioShort": "Studio",
  "tab.glossaryShort": "Glossario",
  "tab.quizShort": "Simulatore",
  "tab.aiShort": "Trainer AI",
  ...
  "study.routeBefore": "Prima di iniziare",
  "study.routeNext": "Dove proseguire",
  ...
  "study.sourcesTitle": "Fonti e revisione",
  "study.sourcesNote": "Con queste fonti puoi verificare i contenuti del dominio. La revisione umana confronta domande, glossario e guida con le fonti: i controlli automatici non contano come revisione.",
  "study.reviewStatus": "Obiettivi del dominio revisionati da una persona: {reviewed} su {total}.",
  "study.primarySources": "Fonti primarie: obiettivi d'esame, standard e norme",
  "study.secondarySources": "Fonti secondarie: riferimenti di comunità ed enti",
  "study.reportError": "Hai trovato un errore? Segnalalo con una issue",
  ...
  "paths.title": "Da dove inizio?",
  "paths.subtitle": "Quattro percorsi guidati, secondo il punto in cui sei.",
  "paths.choose": "Scegli il tuo percorso",
  "paths.stepsFor": "Passi del percorso {name}",
  "paths.actGuide": "Apri la guida del Dominio {n}",
  "paths.actGuideObjective": "Vai all'obiettivo {code}",
  "paths.actGlossary": "Apri il glossario",
  "paths.actQuizMini": "Prepara il quiz Mini",
  "paths.actQuizBalanced": "Prepara il quiz Bilanciato",
  "paths.actExam": "Prepara la simulazione d'esame",
  "paths.actReview": "Vai al ripasso intelligente",
  "paths.actObjective": "Scegli un obiettivo",
  "paths.actAi": "Apri il Trainer AI",
  "chat.accessLabel": "Codice di accesso AI",
  "chat.accessHint": "Chi gestisce questo sito ha protetto le funzioni AI con un codice. Il codice resta solo in questa scheda del browser.",
  "chat.accessSave": "Sblocca",
  "chat.accessRequired": "Le funzioni AI di questo sito richiedono un codice di accesso: inseriscilo qui sotto.",
  "chat.accessSaved": "Codice salvato per questa scheda. Invia di nuovo la domanda.",
  "rem.accessRequired": "Le funzioni AI richiedono un codice di accesso: inseriscilo nel pannello Trainer AI e riprova.",
  "a11y.chatLog": "Conversazione con il Trainer AI",
  "quiz.objectiveDoneTitle": "Quiz sull'obiettivo {code} · {name} completato",
  "quiz.objectiveDoneText": "Rileggi nella guida del Dominio {n} il risultato atteso e i sotto-argomenti ufficiali dell'obiettivo, poi prova gli esercizi guidati sugli stessi temi.",
  "quiz.objectiveDoneBtn": "Ripassa l'obiettivo {code} nella guida",
  "gloss.hintsTitle": "Termini del glossario citati",
  "quiz.onlyDomain": "SOLO DOMINIO:",
  "quiz.onlyObjective": "SOLO OBIETTIVO:",
  "quiz.objectivePlaceholder": "Scegli un obiettivo d'esame…",
  "quiz.objectiveOption": "{code} · {name} ({n} domande)",
  "quiz.startObjective": "Avvia il quiz sull'obiettivo",
  "quiz.objectiveHint": "Tutte le domande che allenano l'obiettivo scelto, in ordine casuale.",
  "ready.title": "Preparazione all'esame",
  "ready.subtitle": "Calcolata dalle risposte salvate in questo browser.",
  "ready.accuracy": "Accuratezza pesata",
  "ready.coverage": "Copertura pesata",
  "ready.noData": "n.d.",
  "ready.explain": "L'accuratezza dice come sono andate le domande a cui hai risposto; la copertura quante domande della banca hai visto. Sono pesate con i pesi ufficiali dei domini. Contano insieme: un'accuratezza alta su una copertura bassa non basta. Soglia di superamento del simulatore: {pass}%.",
  "ready.empty": "Nessuna risposta salvata finora: completa una prova e qui vedrai i tuoi progressi per dominio e per obiettivo.",
  "ready.domainsCaption": "Progressi per dominio",
  "ready.colDomain": "Dominio",
  "ready.colWeight": "Peso",
  "ready.colSeen": "Domande viste",
  "ready.colAccuracy": "Accuratezza",
  "ready.colDue": "Da ripassare",
  "ready.colObjective": "Obiettivo",
  "ready.colQuestions": "Domande",
  "ready.seenOf": "{seen} su {total} ({pct}%)",
  "ready.weakTitle": "Obiettivi più deboli",
  "ready.weakHint": "Servono almeno {n} risposte su un obiettivo per giudicarlo.",
  "ready.weakNone": "Nessun obiettivo ha ancora abbastanza risposte per essere giudicato.",
  "ready.weakItem": "{code} · {name}: {acc}% su {attempts} risposte",
  "ready.train": "Allena l'obiettivo {code}",
  "ready.untouched": "Obiettivi mai allenati: {n} su {total}.",
  "ready.allObjectives": "Tutti gli obiettivi e le domande disponibili ({n})",
  "ready.objectivesCaption": "Copertura della banca e progressi per obiettivo",
  "objective.1.1": "Tipi di controlli di sicurezza",
  "objective.1.2": "Concetti fondamentali di sicurezza",
  "objective.1.3": "Gestione del cambiamento",
  "objective.1.4": "Soluzioni crittografiche",
  "objective.2.1": "Attori delle minacce e motivazioni",
  "objective.2.2": "Vettori di minaccia e superfici di attacco",
  "objective.2.3": "Tipi di vulnerabilità",
  "objective.2.4": "Indicatori di attività malevola",
  "objective.2.5": "Tecniche di mitigazione",
  "objective.3.1": "Modelli di architettura",
  "objective.3.2": "Protezione dell'infrastruttura aziendale",
  "objective.3.3": "Protezione dei dati",
  "objective.3.4": "Resilienza e ripristino",
  "objective.4.1": "Tecniche di sicurezza per le risorse di calcolo",
  "objective.4.2": "Gestione degli asset",
  "objective.4.3": "Gestione delle vulnerabilità",
  "objective.4.4": "Allerta e monitoraggio",
  "objective.4.5": "Capacità di sicurezza aziendali",
  "objective.4.6": "Gestione di identità e accessi",
  "objective.4.7": "Automazione e orchestrazione",
  "objective.4.8": "Risposta agli incidenti",
  "objective.4.9": "Fonti di dati per le indagini",
  "objective.5.1": "Governance della sicurezza",
  "objective.5.2": "Gestione del rischio",
  "objective.5.3": "Rischio delle terze parti",
  "objective.5.4": "Conformità",
  "objective.5.5": "Audit e valutazioni",
  "objective.5.6": "Consapevolezza della sicurezza",
  ...
  "quiz.weakTopicsTitle": "Argomenti da consolidare",
  ...
  "quiz.weaknessDesc": "Il sistema ha tracciato gli errori commessi e isolato i concetti da consolidare, anche se hai superato la soglia dell’80%:",
  "quiz.remediationOffer": "Ripeti subito gli errori oppure chiedi al Trainer AI 3 nuovi scenari di livello ANALISI sugli stessi argomenti.",
  "quiz.generating": "Generazione...",
  "quiz.startAdaptive": "Avvia Recupero Adattivo",
  "quiz.retryMistakes": "Ripeti gli errori",
  ...
  "rem.aiGenerated": "Domanda generata dall'AI in questo momento e non revisionata: verifica le affermazioni sugli obiettivi ufficiali CompTIA.",
  ...
  "chat.disclaimer": "Le risposte dell'AI possono contenere errori e non sostituiscono gli obiettivi ufficiali CompTIA. Non inserire dati personali o riservati.",
  ...
  "chat.invalidAnswer": "risposta del server non valida",
...
const en: Record<UIKey, string> = {
  ...
  "tab.quiz": "High-Stakes Simulator",
  "tab.aiTrainer": "AI Trainer",
  "tab.studioShort": "Study",
  "tab.glossaryShort": "Glossary",
  "tab.quizShort": "Simulator",
  "tab.aiShort": "AI Trainer",
  ...
  "study.routeBefore": "Before you start",
  "study.routeNext": "Where to go next",
  ...
  "study.sourcesTitle": "Sources and review",
  "study.sourcesNote": "These sources let you check the content of the domain. A human review compares questions, glossary and guide with them: automated checks do not count as a review.",
  "study.reviewStatus": "Objectives of the domain reviewed by a person: {reviewed} of {total}.",
  "study.primarySources": "Primary sources: exam objectives, standards and laws",
  "study.secondarySources": "Secondary sources: community and agency references",
  "study.reportError": "Found a mistake? Report it with an issue",
  ...
  "paths.title": "Where do I start?",
  "paths.subtitle": "Four guided paths, depending on where you are.",
  "paths.choose": "Choose your path",
  "paths.stepsFor": "Steps of the {name} path",
  "paths.actGuide": "Open the Domain {n} guide",
  "paths.actGuideObjective": "Go to objective {code}",
  "paths.actGlossary": "Open the glossary",
  "paths.actQuizMini": "Set up the Mini quiz",
  "paths.actQuizBalanced": "Set up the Balanced quiz",
  "paths.actExam": "Set up the exam simulation",
  "paths.actReview": "Go to the smart review",
  "paths.actObjective": "Choose an objective",
  "paths.actAi": "Open the AI Trainer",
  "chat.accessLabel": "AI access code",
  "chat.accessHint": "Whoever runs this site has protected the AI features with a code. The code stays in this browser tab only.",
  "chat.accessSave": "Unlock",
  "chat.accessRequired": "The AI features on this site need an access code: enter it below.",
  "chat.accessSaved": "Code saved for this tab. Send your question again.",
  "rem.accessRequired": "The AI features need an access code: enter it in the AI Trainer panel and try again.",
  "a11y.chatLog": "Conversation with the AI Trainer",
  "quiz.objectiveDoneTitle": "Objective {code} · {name} quiz completed",
  "quiz.objectiveDoneText": "In the Domain {n} guide, reread the expected outcome and the official sub-topics of the objective, then try the guided exercises on the same themes.",
  "quiz.objectiveDoneBtn": "Review objective {code} in the guide",
  "gloss.hintsTitle": "Glossary terms mentioned",
  "quiz.onlyDomain": "DOMAIN ONLY:",
  "quiz.onlyObjective": "OBJECTIVE ONLY:",
  "quiz.objectivePlaceholder": "Choose an exam objective…",
  "quiz.objectiveOption": "{code} · {name} ({n} questions)",
  "quiz.startObjective": "Start the objective quiz",
  "quiz.objectiveHint": "Every question that trains the chosen objective, in random order.",
  "ready.title": "Exam readiness",
  "ready.subtitle": "Worked out from the answers saved in this browser.",
  "ready.accuracy": "Weighted accuracy",
  "ready.coverage": "Weighted coverage",
  "ready.noData": "n/a",
  "ready.explain": "Accuracy tells how the questions you answered went; coverage how many questions of the bank you have seen. Both use the official domain weights. They count together: high accuracy on low coverage is not enough. Simulator pass mark: {pass}%.",
  "ready.empty": "No saved answers yet: complete a run and your progress by domain and objective will show here.",
  "ready.domainsCaption": "Progress by domain",
  "ready.colDomain": "Domain",
  "ready.colWeight": "Weight",
  "ready.colSeen": "Questions seen",
  "ready.colAccuracy": "Accuracy",
  "ready.colDue": "Due for review",
  "ready.colObjective": "Objective",
  "ready.colQuestions": "Questions",
  "ready.seenOf": "{seen} of {total} ({pct}%)",
  "ready.weakTitle": "Weakest objectives",
  "ready.weakHint": "An objective needs at least {n} answers before it is judged.",
  "ready.weakNone": "No objective has enough answers to be judged yet.",
  "ready.weakItem": "{code} · {name}: {acc}% over {attempts} answers",
  "ready.train": "Train objective {code}",
  "ready.untouched": "Objectives never trained: {n} of {total}.",
  "ready.allObjectives": "All objectives and available questions ({n})",
  "ready.objectivesCaption": "Bank coverage and progress by objective",
  ...
  "objective.3.2": "Securing enterprise infrastructure",
  ...
  "quiz.weakTopicsTitle": "Topics to strengthen",
  ...
  "quiz.weaknessDesc": "The system tracked your mistakes and isolated the concepts to strengthen, even if you cleared the 80% threshold:",
  "quiz.remediationOffer": "Retry the mistakes now or ask the AI Trainer for 3 new ANALYSIS-level scenarios on the same topics.",
  "quiz.generating": "Generating...",
  "quiz.startAdaptive": "Start Adaptive Remediation",
  "quiz.retryMistakes": "Retry mistakes",
  ...
  "rem.aiGenerated": "Question generated by the AI just now and not reviewed: check its claims against the official CompTIA objectives.",
  ...
  "chat.disclaimer": "AI answers can be wrong and do not replace the official CompTIA objectives. Do not enter personal or confidential data.",
  ...
  "chat.invalidAnswer": "invalid answer from the server",
