...
- Container image scan with Grype in the security workflow: it fails on high or critical vulnerabilities that have a fix and reports them in the Security tab.
